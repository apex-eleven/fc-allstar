...
export const ROSTER: RosterEntry[] = [
  ...
  { file: 'p269.gif', rarity: 'legendary', name: 'MUSIALA', position: 'ST', ovr: 120 },
  { file: 'p270.gif', rarity: 'legendary', name: 'CARRASCO', position: 'LW', ovr: 119 },
  { file: 'p272.gif', rarity: 'legendary', name: 'MATHEUS CUNHA', position: 'CAM', ovr: 120 },
  { file: 'p273.gif', rarity: 'mythical', name: 'HAZARD', position: 'LW', ovr: 121 },
  { file: 'p274.gif', rarity: 'epic', name: 'BERARDI', position: 'RW', ovr: 118 },
  { file: 'p275.gif', rarity: 'legendary', name: 'GIBBS WHITE', position: 'CAM', ovr: 119 },
  { file: 'p276.gif', rarity: 'epic', name: 'AMIRI', position: 'CM', ovr: 118 },
  { file: 'p277.gif', rarity: 'epic', name: 'BAGGIO', position: 'CAM', ovr: 118 },
  { file: 'p278.gif', rarity: 'legendary', name: 'ROONEY', position: 'ST', ovr: 119 },
  { file: 'p279.gif', rarity: 'epic', name: 'ALMIRON', position: 'RW', ovr: 117 },
  { file: 'p280.gif', rarity: 'epic', name: 'EZE', position: 'CAM', ovr: 117 },
  { file: 'p281.gif', rarity: 'epic', name: 'ROONEY', position: 'ST', ovr: 117 },
  { file: 'p282.gif', rarity: 'legendary', name: 'MAC ALLISTER', position: 'CM', ovr: 119 },
  { file: 'p283.gif', rarity: 'epic', name: 'NICOPAZ', position: 'CAM', ovr: 118 },
  { file: 'p284.gif', rarity: 'common', name: 'AIMAR OROZ', position: 'CAM', ovr: 113 },
  { file: 'p285.gif', rarity: 'common', name: 'BLAS', position: 'RM', ovr: 112 },
  { file: 'p286.gif', rarity: 'common', name: 'DIOP', position: 'LW', ovr: 113 },
  { file: 'p287.gif', rarity: 'rare', name: 'FUHRICH', position: 'LM', ovr: 115 },
  { file: 'p288.gif', rarity: 'common', name: 'GOLOVIN', position: 'LM', ovr: 114 },
  { file: 'p289.gif', rarity: 'common', name: 'GUDMUNDSSON', position: 'ST', ovr: 114 },
  { file: 'p290.gif', rarity: 'common', name: 'MEERVELD', position: 'CAM', ovr: 113 },
  { file: 'p291.gif', rarity: 'common', name: 'VLASIC', position: 'CAM', ovr: 114 },
  { file: 'p292.gif', rarity: 'common', name: 'NEUHAUS', position: 'CM', ovr: 112 },
  { file: 'p293.gif', rarity: 'rare', name: 'WANNER', position: 'CAM', ovr: 116 },
  { file: 'p294.gif', rarity: 'common', name: 'THAUVIN', position: 'ST', ovr: 115 },
  { file: 'p295.gif', rarity: 'legendary', name: 'VAN DIJK', position: 'CB', ovr: 120 },
  { file: 'p296.gif', rarity: 'legendary', name: 'MBAPPE', position: 'ST', ovr: 120 },
  { file: 'p297.gif', rarity: 'legendary', name: 'DONNARUMMA', position: 'GK', ovr: 120 },
  { file: 'p298.gif', rarity: 'legendary', name: 'BELLINGHAM', position: 'CM', ovr: 120 },
  { file: 'p299.gif', rarity: 'rare', name: 'MAGUIRE', position: 'CB', ovr: 116 },
  { file: 'p300.gif', rarity: 'rare', name: 'RICE', position: 'CDM', ovr: 116 },
  { file: 'p301.gif', rarity: 'rare', name: 'RAPHINHA', position: 'LW', ovr: 116 },
  { file: 'p302.gif', rarity: 'rare', name: 'GRIMALDO', position: 'LM', ovr: 116 },
  { file: 'p303.gif', rarity: 'common', name: 'UNAI SIMON', position: 'GK', ovr: 115 },
  { file: 'p304.gif', rarity: 'common', name: 'IAGO ASPAS', position: 'RW', ovr: 115 },
  { file: 'p305.gif', rarity: 'common', name: 'ISCO', position: 'CAM', ovr: 115 },
  ...
  { file: 'p312.png', rarity: 'mythical', name: 'FERDINAND', position: 'CB', ovr: 123 },
  { file: 'p313.png', rarity: 'mythical', name: 'GULLIT', position: 'CM', ovr: 123 },
];
