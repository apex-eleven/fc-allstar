...
export const ROSTER: RosterEntry[] = [
  ...
  /* ── NUMERO 10  ─────────────────────────────────────────*/
  { file: '265.gif', rarity: 'mythical', name: 'ZIDANE', position: 'CM', ovr: 122 },
  { file: '266.gif', rarity: 'mythical', name: 'PELE', position: 'CAM', ovr: 122 },
  { file: '267.gif', rarity: 'mythical', name: 'DEMBELE', position: 'ST', ovr: 122 },
  { file: '268.gif', rarity: 'mythical', name: 'BERGKAMP', position: 'ST', ovr: 121 },
  { file: '269.gif', rarity: 'mythical', name: 'MUSIALA', position: 'ST', ovr: 120 },
  { file: '270.gif', rarity: 'mythical', name: 'CARRASCO', position: 'LW', ovr: 119 },
  { file: '272.gif', rarity: 'mythical', name: 'MATHEUS CUNHA', position: 'CAM', ovr: 120 },
  { file: '273.gif', rarity: 'mythical', name: 'HAZARD', position: 'LW', ovr: 121 },
  { file: '274.gif', rarity: 'mythical', name: 'BERARDI', position: 'RW', ovr: 118 },
  { file: '275.gif', rarity: 'mythical', name: 'GIBBS WHITE', position: 'CAM', ovr: 119 },
  { file: '276.gif', rarity: 'mythical', name: 'AMIRI', position: 'CM', ovr: 118 },
  { file: '277.gif', rarity: 'mythical', name: 'BAGGIO', position: 'CAM', ovr: 118 },
  { file: '278.gif', rarity: 'mythical', name: 'ROONEY', position: 'ST', ovr: 119 },
  { file: '279.gif', rarity: 'mythical', name: 'ALMIRON', position: 'RW', ovr: 117 },
  { file: '280.gif', rarity: 'mythical', name: 'EZE', position: 'CAM', ovr: 117 },
  { file: '281.gif', rarity: 'mythical', name: 'ROONEY', position: 'ST', ovr: 117 },
  { file: '282.gif', rarity: 'mythical', name: 'MAC ALLISTER', position: 'CM', ovr: 119 },
  { file: '283.gif', rarity: 'mythical', name: 'NICOPAZ', position: 'CAM', ovr: 118 },
  { file: '284.gif', rarity: 'mythical', name: 'AIMAR OROZ', position: 'CAM', ovr: 113 },
  { file: '285.gif', rarity: 'mythical', name: 'BLAS', position: 'RM', ovr: 112 },
  { file: '286.gif', rarity: 'mythical', name: 'DIOP', position: 'LW', ovr: 113 },
  { file: '287.gif', rarity: 'mythical', name: 'FUHRICH', position: 'LM', ovr: 115 },
  { file: '288.gif', rarity: 'mythical', name: 'GOLOVIN', position: 'LM', ovr: 114 },
  { file: '289.gif', rarity: 'mythical', name: 'GUDMUNDSSON', position: 'ST', ovr: 114 },
  { file: '290.gif', rarity: 'mythical', name: 'MEERVELD', position: 'CAM', ovr: 113 },
  { file: '291.gif', rarity: 'mythical', name: 'VLASIC', position: 'CAM', ovr: 114 },
  { file: '292.gif', rarity: 'mythical', name: 'NEUHAUS', position: 'CM', ovr: 112 },
  { file: '293.gif', rarity: 'mythical', name: 'WANNER', position: 'CAM', ovr: 116 },
  { file: '294.gif', rarity: 'mythical', name: 'THAUVIN', position: 'ST', ovr: 115 },
  { file: '295.gif', rarity: 'mythical', name: 'VAN DIJK', position: 'CB', ovr: 120 },
  { file: '296.gif', rarity: 'mythical', name: 'MBAPPE', position: 'SST', ovr: 120 },
  { file: '297.gif', rarity: 'mythical', name: 'DONNARUMMA', position: 'GK', ovr: 120 },
  { file: '298.gif', rarity: 'mythical', name: 'BELLINGHAM', position: 'CM', ovr: 120 },
  { file: '299.gif', rarity: 'mythical', name: 'MAGUIRE', position: 'CB', ovr: 116 },
  { file: '300.gif', rarity: 'mythical', name: 'RICE', position: 'CDM', ovr: 116 },
  { file: '301.gif', rarity: 'mythical', name: 'RAPHINHA', position: 'LW', ovr: 116 },
  { file: '302.gif', rarity: 'mythical', name: 'GRIMALDO', position: 'LM', ovr: 116 },
  { file: '303.gif', rarity: 'mythical', name: 'UNAI SIMON', position: 'GK', ovr: 115 },
  { file: '304.gif', rarity: 'mythical', name: 'IAGO ASPAS', position: 'RW', ovr: 115 },
  { file: '305.gif', rarity: 'mythical', name: 'ISCO', position: 'CAM', ovr: 115 },
  { file: '306.gif', rarity: 'mythical', name: 'OYARZABAL', position: 'ST', ovr: 115 },
];
