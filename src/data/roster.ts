...
export const ROSTER: RosterEntry[] = [
  ...
  { file: 'p272.gif', rarity: 'mythical', name: 'MATHEUS CUNHA', position: 'CAM', ovr: 120 },
  { file: 'p273.gif', rarity: 'mythical', name: 'HAZARD', position: 'LW', ovr: 121 },
  { file: 'p274.gif', rarity: 'mythical', name: 'BERARDI', position: 'RW', ovr: 118 },
  { file: 'p275.gif', rarity: 'mythical', name: 'GIBBS WHITE', position: 'CAM', ovr: 119 },
  { file: 'p276.gif', rarity: 'mythical', name: 'AMIRI', position: 'CM', ovr: 118 },
  { file: 'p277.gif', rarity: 'mythical', name: 'BAGGIO', position: 'CAM', ovr: 118 },
  { file: 'p278.gif', rarity: 'mythical', name: 'ROONEY', position: 'ST', ovr: 119 },
  { file: 'p279.gif', rarity: 'mythical', name: 'ALMIRON', position: 'RW', ovr: 117 },
  { file: 'p280.gif', rarity: 'mythical', name: 'EZE', position: 'CAM', ovr: 117 },
  { file: 'p281.gif', rarity: 'mythical', name: 'ROONEY', position: 'ST', ovr: 117 },
  { file: 'p282.gif', rarity: 'mythical', name: 'MAC ALLISTER', position: 'CM', ovr: 119 },
  { file: 'p283.gif', rarity: 'mythical', name: 'NICOPAZ', position: 'CAM', ovr: 118 },
  { file: 'p284.gif', rarity: 'mythical', name: 'AIMAR OROZ', position: 'CAM', ovr: 113 },
  { file: 'p285.gif', rarity: 'mythical', name: 'BLAS', position: 'RM', ovr: 112 },
  { file: 'p286.gif', rarity: 'mythical', name: 'DIOP', position: 'LW', ovr: 113 },
  { file: 'p287.gif', rarity: 'mythical', name: 'FUHRICH', position: 'LM', ovr: 115 },
  { file: 'p288.gif', rarity: 'mythical', name: 'GOLOVIN', position: 'LM', ovr: 114 },
  { file: 'p289.gif', rarity: 'mythical', name: 'GUDMUNDSSON', position: 'ST', ovr: 114 },
  { file: 'p290.gif', rarity: 'mythical', name: 'MEERVELD', position: 'CAM', ovr: 113 },
  { file: 'p291.gif', rarity: 'mythical', name: 'VLASIC', position: 'CAM', ovr: 114 },
  { file: 'p292.gif', rarity: 'mythical', name: 'NEUHAUS', position: 'CM', ovr: 112 },
  { file: 'p293.gif', rarity: 'mythical', name: 'WANNER', position: 'CAM', ovr: 116 },
  { file: 'p294.gif', rarity: 'mythical', name: 'THAUVIN', position: 'ST', ovr: 115 },
  { file: 'p295.gif', rarity: 'mythical', name: 'VAN DIJK', position: 'CB', ovr: 120 },
  { file: 'p296.gif', rarity: 'mythical', name: 'MBAPPE', position: 'SST', ovr: 120 },
  { file: 'p297.gif', rarity: 'mythical', name: 'DONNARUMMA', position: 'GK', ovr: 120 },
  { file: 'p298.gif', rarity: 'mythical', name: 'BELLINGHAM', position: 'CM', ovr: 120 },
  { file: 'p299.gif', rarity: 'mythical', name: 'MAGUIRE', position: 'CB', ovr: 116 },
  { file: 'p300.gif', rarity: 'mythical', name: 'RICE', position: 'CDM', ovr: 116 },
  { file: 'p301.gif', rarity: 'mythical', name: 'RAPHINHA', position: 'LW', ovr: 116 },
  { file: 'p302.gif', rarity: 'mythical', name: 'GRIMALDO', position: 'LM', ovr: 116 },
  { file: 'p303.gif', rarity: 'mythical', name: 'UNAI SIMON', position: 'GK', ovr: 115 },
  { file: 'p304.gif', rarity: 'mythical', name: 'IAGO ASPAS', position: 'RW', ovr: 115 },
  { file: 'p305.gif', rarity: 'mythical', name: 'ISCO', position: 'CAM', ovr: 115 },
  { file: 'p306.gif', rarity: 'mythical', name: 'OYARZABAL', position: 'ST', ovr: 115 },
];
