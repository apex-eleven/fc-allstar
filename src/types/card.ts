...
export interface CardPack {
  ...
  pool?: string[];
  /**
   * โอกาสที่การ์ดจากซองนี้จะออกมาพร้อมค่าตีบวก — 9 ช่อง = น้ำหนักของ +0, +1, … , +8
   *
   * ไม่ใส่ = การ์ดออกมาเป็น +0 ทุกใบเหมือนเดิม (ซองเก่าทุกใบจึงไม่กระทบ)
   * ใส่ = สุ่มค่าตีบวกต่อการ์ดหนึ่งใบ แยกกันคนละครั้งกับการสุ่ม rarity
   * ไม่ต้องรวมกันได้ 100 ระบบคิดเป็นสัดส่วนให้เอง
   */
  upgradeOdds?: number[];
  description: string;
  /**
